...
/*
class RDBannerView(context: Context) : FrameLayout(context), LifecycleEventListener {
  ...
  private fun notify(eventName: String, event: WritableMap) {
    ...
    reactContext.rdDispatchEvent(id, eventName, event)
  }
