import { Text, View, SafeAreaView, StyleSheet, ScrollView, TouchableOpacity, TextInput, Switch, StatusBar, Alert, Platform, Dimensions } from 'react-native'
...
const appAlias = Platform.OS === 'android' ? 'rnandroidtestapptest2' : 'rniostestapptest2'
...
export default class Home extends Component {
  ...
  addListeners = () => {
    ...
    addEventListener('inAppUrlClicked', async (inAppUrlInfo) => { console.log('inAppUrlInfo is ', inAppUrlInfo) }, euroMessageApi, visilabsApi)
